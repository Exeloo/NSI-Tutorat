export const labels = new Map([
  ...
  ['fr', 'Français'],
  ['maths', 'Mathématiques'],
  ['mathsSpe', 'Mathématiques Spécifiques'],
  ['pc', 'Physique-Chimie'],
...
export const correspondingTable = new Map([
  ['fr', ['fr']],
  ['maths', ['maths', 'mathsSpe', 'maths-compl-opt', 'maths-dnl']],
  ['mathsSpe', ['mathsSpe', 'maths', 'sl-opt', 'maths-dnl']],
  ['pc', ['pc']],
  ['ses', ['ses']],
  ['snt', ['snt']],
  ['svt', ['svt']],
  ...
  ['maths-spe', ['maths-spe', 'maths', 'mathsSpe', 'maths-compl-opt', 'pcm-tspe', 'sl-opt', 'maths-dnl']],
  ...
  ['ap-opt', ['ap-opt']],
  ['cav-opt', ['cav-opt']],
  ['maths-expert-opt', ['maths-expert-opt', 'maths-spe', 'maths', 'mathsSpe', 'maths-compl-opt', 'pcm-tspe', 'sl-opt', 'maths-dnl']],
  ['maths-compl-opt', ['maths-compl-opt', 'maths-spe', 'maths', 'mathsSpe', 'pcm-tspe', 'sl-opt', 'maths-dnl']],
